...
userSchema.pre('save', async function () {
    const eventData = {
      ...
      // This is a new user
      console.log('--- New user, publishing UserCreated event... ---');
      try {
        await publishEvent('UserCreated', eventData);
        console.log('--- UserCreated event successfully published! ---');
      } catch (err) {
          console.error("❌ Failed to publish UserCreated event:", err.message);
        }
    
      // This is an existing user with changes
      console.log('--- User data changed, publishing UserUpdated event... ---');
      try {
        await publishEvent('UserUpdated', eventData);
        console.log('--- UserUpdated event successfully published! ---');
      } catch (err) {
          console.error("❌ Failed to publish UserUpdated event:", err.message);
        }
